    ...
    posts={[
    {
        structured_content: {
          nodes: [
            ...
            {
              paragraph: {
                text: "We are Jack and Olga and we are here to share photos and stories of our traveling adventures!"
              }
            },            
            {
              paragraph: {
...
Our plan is to:
            ...
            {
              paragraph: {
                text: "We have never done extended traveling before, so this is hopefully going to be a great experience for not only us, but you as well, as we wish to share all the ups and downs of newbie couple traveling."
              }
            },            
            {
              paragraph: {
