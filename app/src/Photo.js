...
class Photo extends React.Component {
  ...
  clickable() {
    return this.props.url.includes("storage.googleapis.com");
  }

  largeUrl() {
    if (this.props.url.includes("storage.googleapis.com")) {
      return this.props.url.replace(".jpg", ".full.jpg");
    }
  ...
  render() {
    ...
    const className = this.clickable()
    ...
    return (
      <div className="img">
        ...
        <h3 className="location-text">{props.title}</h3>
